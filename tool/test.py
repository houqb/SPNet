...
def main():
    ...
    if not args.has_prediction:
        ...
        test(test_loader, test_data, model, args.classes, mean, std, args.base_size, args.test_h, args.test_w, args.scales, gray_folder, color_folder, colors)
    if args.split != 'test':
        cal_acc(test_data, gray_folder, args.classes, names)
...
def test(test_loader, test_data, model, classes, mean, std, base_size, crop_h, crop_w, scales, gray_folder, color_folder, colors):
...
def cal_acc(test_data, pred_folder, classes, names):
